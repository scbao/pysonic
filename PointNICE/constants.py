...
# @Last Modified time: 2017-08-25 11:56:18
...
# A-STIM Generic integration constants
...
# A-STIM Titrations
TITRATION_A_MAX = 2e5  # initial acoustic pressure upper bound for titration procedure (Pa)
TITRATION_DA_THR = 1e3  # acoustic pressure search range threshold for titration procedure (Pa)
TITRATION_T_MAX = 2e-1  # initial stimulus duration upper bound for titration procedure (s)
TITRATION_DT_THR = 1e-3  # stimulus duration search range threshold for titration procedure (s)
TITRATION_DDF_THR = 0.01  # stimulus duty cycle search range threshold for titration procedure (-)
TITRATION_DF_MAX = 1.0  # initial stimulus duty cycle upper bound for titration procedure (-)
